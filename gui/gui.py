...
class App(Tk):
    ...
    def initGrid(self, cols, rows, size, debug):
        ...
        if (size_of_game == "10x10"):
            ...
            cRB = 225
            openP = self.hexagons
        CornerLeft(self.can, self.hexagons[cL].y+7,self.hexagons[cL].x-22, "A-55")            #5x5 : 115,   6x6: 106, 7x7: 98,  8x8:57,   9x9:  56, 10x10: 36
        CornerRight(self.can, self.hexagons[cR].y -19, self.hexagons[cR].x - 22, "A-55")      #5x5 : 119,   6x6: 111, 7x7: 104  8x8:96,   9x9:  89, 10x10: 81
        CornerRightMiddle(self.can, self.hexagons[cRM].y +20, self.hexagons[cRM].x-33, "A-55" ) # 5x5 : 153,  6x6: 234, 7x7: 249, 8x8:260,  9x9:  267,10x10: 270
        CornerLeftMiddle(self.can, self.hexagons[cLM].y+20 ,self.hexagons[cLM].x-33 ,"A-55")     # 5x5 : 64,   6x6: 45,  7x7: 28,  8x8:15,   9x9:  6,  10x10: 1
        CornerLeftBottom(self.can, self.hexagons[cLB].y-19 ,self.hexagons[cLB].x -10, "A-55")   # 5x5 : 179,  6x6: 186, 7x7: 194, 8x8:71,   9x9:  72, 10x10: 54
        CornerRightBottom(self.can, self.hexagons[cRB].y +57,self.hexagons[cRB].x -10, "A-55")  # 5x5 : 183,  6x6: 191, 7x7: 200, 8x8:208,  9x9:  217,10x10: 225
